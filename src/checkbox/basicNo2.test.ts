...
describe('test formio stats', () => {
  ...
  var formioResult4 = {
    ...
    const res = distribution([formioResult1, formioResult2, formioResult3, formioResult4], ['under18','married'])
    equal(res.percentageOfTrue, [75, 75])
    equal(res.percentageOfFalse, [25, 25])
  })
})
