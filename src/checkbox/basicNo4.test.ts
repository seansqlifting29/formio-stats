import {distribution} from './basicNo4'
...
describe('test formio stats', () => {
  ...
  var formioResult4 = {
    ...
    const res = distribution([formioResult1, formioResult2, formioResult3, formioResult4], 'textArea')
      equal(res, "formio - results - statistics is intended for checkbox results.Please go back and insert only attributes that map strictly to boolean values.")
  })
})
